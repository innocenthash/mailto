   ...
   <div class="row">
      ...
      <div class="col-6">
        <form class="was-validated" >
         <h2 class="inscrition">Se Connec</h2>
           ...
           <a href="#" class="  btn btn-success btn-block" id="btn-connect">ENREGISTRER</a>
           <a href="<?php    echo 'http://localhost/Mailto/Caccueil/formulaire'        ?>" class="btn" id="btnseconnect" style="color: white;">S'inscrire</a>
